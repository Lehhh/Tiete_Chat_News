...
public class TelaInicial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        menuAddUserButton = new javax.swing.JMenuItem();
        menuAddWordButton = new javax.swing.JMenuItem();
        ...
        jMenuItem8.setText("Perguntas Frequentes");
        ...
        menuAddUserButton.setText("Adicionar Usuários");
        menuAddUserButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menuAddUserButtonActionPerformed(evt);
            }
        });
        jMenu10.add(menuAddUserButton);

        menuAddWordButton.setText("Adicionar palavras bloqueadas");
        menuAddWordButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menuAddWordButtonActionPerformed(evt);
            }
        });
        jMenu10.add(menuAddWordButton);
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        try {
            ...
            jEditorPane1.setText(tHtml.getHTML(Strings.URL_CETESB_HISTORICO, Strings.INICIO_CETESB_HISTORICO, Strings.FIM_CETESB_HISTORICO));
...
//        jEditorPane1.setText(response.replace("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">", ""));
    ...
    private void jMenuItem8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem8ActionPerformed
        try {
            jEditorPane1.setText("");
            jEditorPane1.setText(tHtml.getHTML(Strings.URL_CETESB_PERGUNTAS_FREQUENTES, Strings.INICIO_PERGUNTAS_FREQUENTES, Strings.FIM_PERGUNTAS_FREQUENTES));
        } catch (IOException ex) {
            Logger.getLogger(TelaInicial.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
    	try {
            jEditorPane1.setText("");
            jEditorPane1.setText(tHtml.getHTML(Strings.URL_CETESB_LICITACOES, Strings.INICIO_CETESB_LICITACOES, Strings.FIM_CETESB_LICITACOES));
        } catch (IOException ex) {
            Logger.getLogger(TelaInicial.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        try {
            jEditorPane1.setText("");
            urlNewsComplete = tHtml.getArrayBeginUrlNews();
    ...
    private void menuAddWordButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuAddWordButtonActionPerformed
    		AddWord adw = new AddWord();
    		adw.setVisible(true);
    
    }//GEN-LAST:event_menuAddWordButtonActionPerformed
...
//                    new TelaInicial().setVisible(true);
    ...
    private javax.swing.JMenuItem menuAddUserButton;
    private javax.swing.JMenuItem menuAddWordButton;
